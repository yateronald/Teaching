...
/**
 * Batch assignment notification sent to a teacher.
 *
 * @param {{
 *   teacherName?: string,
 *   batchName?: string,
 ...
 * }} args
 */
function buildBatchAssignmentTeacherTemplate({
    teacherName,
    batchName,
    frenchLevel,
    startDate,
    ...
    const subject = `New batch assigned: ${safeBatch}`;
    const preheader = `You have been assigned to ${safeBatch}. Full details inside.`;
    ...
    const bodyHtml = `
      ...
      <p style="margin:0 0 22px; font-size:14.5px; color:#475569; line-height:1.65;">
        You've been assigned to a new batch. The full details are below.
      </p>
      ...
      <p style="margin: 18px 0 0; font-size: 13px; color: #94a3b8; line-height: 1.6;">
        If anything looks off, reach out to your administrator.
      </p>
    `;
    ...
    const html = baseHtml({
        ...
        preheader,
        eyebrow: 'TEACHING',
        title: "You've been assigned a new batch",
        bodyHtml,
    });
